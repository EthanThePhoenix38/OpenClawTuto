# 🎯 1.1 - Qu'est-ce qu'Phoenix ?

## 📋 Ce que tu vas apprendre

- L'histoire d'Phoenix (de Clawdbot à aujourd'hui)
- Ce que fait Phoenix concrètement
...
**Phoenix**, c'est ton assistant IA personnel qui vit sur TON ordinateur. Imagine un assistant comme ChatGPT, mais qui :
...
## 📖 L'histoire : De Clawdbot à Phoenix
...
Finalement, le projet est devenu **Phoenix** en janvier 2026 :
...
## 🔧 Que fait Phoenix concrètement ?

### 1. Gateway (Passerelle)

Le **Gateway** est le cœur d'Phoenix. C'est un serveur local qui :
...
Phoenix supporte **12+ messageries** :
...
## 🌟 Pourquoi Phoenix est différent ?

### vs ChatGPT / Claude.ai

| Aspect | ChatGPT/Claude.ai | Phoenix |
|--------|-------------------|----------|
...
Phoenix est le **seul** assistant qui combine :
...
- [ ] J'ai compris ce qu'est Phoenix (assistant IA local multi-messageries)
- [ ] J'ai compris l'histoire (Clawdbot → MoltBot → Phoenix)
...
- [Site officiel Phoenix](https://phoenix.ai/)
- [Documentation officielle](https://docs.phoenix.ai/)
- [GitHub Phoenix](https://github.com/phoenix/phoenix)
- [Annonce du rebranding (janvier 2026)](https://medium.com/@balazskocsis/phoenix-now-with-tighter-security-a063ecf564ff)
